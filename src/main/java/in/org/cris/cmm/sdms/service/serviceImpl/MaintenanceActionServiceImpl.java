...
import in.org.cris.cmm.sdms.dto.MaintenanceActionResponseDTO;
...
public class MaintenanceActionServiceImpl implements MaintenanceActionService {
        ...
        public MaintenanceActionMaster saveOrUpdate(MaintenanceActionDTO dto) {
                ...
                if (dto.getActionId() != null) {
                        entity = maintenanceActionRepository.findById(dto.getActionId()).orElseThrow(() -> new RuntimeException("Action not found: " + dto.getActionId()));
