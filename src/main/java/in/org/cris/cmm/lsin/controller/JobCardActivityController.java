...
import in.org.cris.cmm.lsin.service.JobCardActivityService;
...
public class JobCardActivityController {
        ...
        public ResponseEntity<?> saveOrUpdate(@RequestBody JobCardActivityDTO dto) {
                ...
                return ResponseEntity.status(status).body(new APIsResponse<>(status, (dto.getActivityId() == null) ? "Activity created successfully" : "Activity updated successfully", saved));
        }
